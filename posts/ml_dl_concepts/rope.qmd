...
So, RoPE is encoding the relative position information in the attention calculation, which we wanted. We looked only at a 2D case and want to generalize this for N dimensions. But before doing that, let us look at it from another angle, similar to what was presented in the Roformer paper.
