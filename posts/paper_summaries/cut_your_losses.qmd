...
product between columns C~xi~ and E~i~ in a single CUDA/Triton kernel.
...
* Backward pass: Needs two gradient updates. The gradient is defined as shown below.
<br>
...
<br>
  ...
  affecting the softmax matrix. For any column in that matrix, at most \frac{1}{ε} = 4096 entries have
