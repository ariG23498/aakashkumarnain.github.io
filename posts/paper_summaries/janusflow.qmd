...
1. **Autoregression Objective:** For multimodal understanding tasks, 𝑥𝑟𝑒𝑠 contains only text tokens, and
the model is trained using the maximum likelihood principle where the loss is calculated over tokens in
xres.
2. **Rectified Flow Objective:** For image generation tasks, 𝑥𝑐𝑜𝑛 consists of text tokens and 𝑥𝑟𝑒𝑠 is the
